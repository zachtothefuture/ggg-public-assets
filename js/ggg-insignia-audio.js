...
VERSION
v2.9 — Mobile-Safe Ambient Ducking
PURPOSE
...
/*
  Establish ambient ducking during the same user
  interaction that requests foreground playback.

  This is especially important on mobile, where the
  ambient layer may still be completing its initial
  playback unlock.
*/
